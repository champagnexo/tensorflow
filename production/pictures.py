...
def capture_image(output_dir, filename=None, resolution=(1920, 1080), 
                 delay=3, sharpness=2.0, format='png'):
    """
    ...
    try:
        ...
        print(f"Initializing camera (resolution: {resolution}, format: {format.upper()})...")
        ...
        # Capture in PNG format (lossless)
